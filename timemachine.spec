...
?package(%{name}): command="%{name}" icon="sound_section.png" needs="x11" title="JACK TimeMachine" longtitle="Records audio from ten seconds ago" section="Multimedia/Sound" xdg="true"
EOF
